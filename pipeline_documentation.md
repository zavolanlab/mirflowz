...
[custom-script-iso-tag]: workflow/scripts/annotate_sam_with_bed_features.py
[custom-script-map-chr]: workflow/scripts/map_chromosomes.pl
[custom-script-merge-tab]: workflow/scripts/merge_tables.R
[custom-script-mir-ext]: workflow/scripts/mirna_extension.py
[custom-script-mir-quant]: workflow/scripts/mirna_quantification.py
[custom-script-nh-filter]: workflow/scripts/nh_filter.py
[custom-script-oligo-sam]: workflow/scripts/oligomap_output_to_sam_nh_filtered.py
[custom-script-pri-quant]: workflow/scripts/primir_quantification.py
[custom-script-remove-dup]: workflow/scripts/sam_remove_duplicates_inferior_alignments_multimappers.pl
[custom-script-sam-trx]: workflow/scripts/sam_trx_to_sam_gen.pl
[custom-script-trim-id]: workflow/scripts/trim_id_fasta.sh
[custom-script-uncollapse]: workflow/scripts/sam_uncollapse.pl
[custom-script-validation]: workflow/scripts/validation_fasta.py
