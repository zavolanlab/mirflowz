...
example, the feature name 'feat_name_1|0|0|23M|23|read_seq' would represent a
canonical miRNA and the feature names 'feat_name_2|0|0|22M|0A0A2T17|read_seq'
...
def get_name(pre_name: str) -> list[str]:
    ...
    Args:
        pre_name:
            string with the format feat_name|5-shift|3-shift|CIGAR|MD|read_seq
